    ...
    <div class="main-section">
        <div class="add-section">
            <form action="app/add.php" method="POST" autocomplete="off">
                ...
                ?>
                    <input style="border-color: #ff6666;" type="text" name="title" placeholder="This field is required">
        ...
        <div class="show-todo-section">
            ...
            ?>
                <div class="todo-item">
                    ...
                    if ($todo['checked']) {
                    ?>
                        <input class="check-box" type="checkbox" checked data-todo-id="<?php echo $todo['id']; ?>">
